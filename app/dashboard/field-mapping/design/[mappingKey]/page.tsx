...
export default function FieldMappingDesignPage() {
    ...
    <div className="min-h-screen bg-gray-50 ns-font">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" onClick={() => router.push('/dashboard/field-mapping')}>
            <ArrowLeft className="h-4 w-4 mr-2" />
            返回
          </Button>
              <div>
                <h1 className="text-xl font-bold text-gray-900">欄位映射設計</h1>
