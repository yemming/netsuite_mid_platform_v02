...
export default function ESSDashboardPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">員工自助服務</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent className="space-y-2">
            <Link href="/hcm/ess/forms">
              <Button variant="outline" className="w-full justify-start">
                <FileText className="mr-2 h-4 w-4" />
                表單申請
              </Button>
            </Link>
            <Link href="/hcm/ess/approvals">
              <Button variant="outline" className="w-full justify-start">
                <CheckCircle2 className="mr-2 h-4 w-4" />
                我的審批
              </Button>
            </Link>
            <Link href="/hcm/ess/payslip">
              <Button variant="outline" className="w-full justify-start">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">部門：研發部</span>
              </div>
              <div className="flex items-center gap-2">
                <User className="h-4 w-4 text-gray-400" />
                <span className="text-sm">職位：資深工程師</span>
              </div>
              <div className="flex items-center gap-2">
                <User className="h-4 w-4 text-gray-400" />
                <span className="text-sm">工號：EMP001</span>
              </div>
            </div>
          </CardContent>
        </Card>
